...
export default function WorkspaceHeader({
  ...
  return (
    <>
      <header className="h-16 border-b border-zinc-800 bg-zinc-900/50 backdrop-blur-md px-6 flex items-center justify-between shrink-0 z-50">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="p-2 rounded-xl bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-zinc-400 hover:text-indigo-300 transition-all"
      ...
      <HelpShortcutsModal open={helpOpen} onClose={() => onHelpOpenChange?.(false)} />
    </>
  );
}
