export const INITIAL_CAPTIONS = [
  {
    ...
    xRel: 0.5, yRel: 0.82, textAlign: 'center', animation: 'none', animationDuration: 0.5, animationAnimateAll: true
  },
  {
...
export const DEFAULT_CAPTION_STYLES = {
  preset: 'bold-kinetic',
...
export const DEFAULT_CAPTION_FIELDS = {
  xRel: 0.5,
  yRel: 0.82,
  animation: 'none',
